...
<head>
    ...
    <link rel="icon" href="./assets/notapple.png" type="image/x-icon">
...
<body>
    ...
    <header id="header">
        ...
        <nav class="navbar navbar-expand-lg px-3 navbar-dark color-second-bg">
            <img src="./assets/notapple.png" class="logo" style="width: 70px; height: 70px;">
            <a class="navbar-brand" href="./index.php" style="font-size: 14px;"></a>
